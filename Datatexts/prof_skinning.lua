...
local profession = "Skinning";
local BonusRace = 'Worgen';
local SkillCap = 600
local Racial = 15
...
DT:RegisterDatatext('Prof Skinning', {"PLAYER_ENTERING_WORLD", "SKILL_LINES_CHANGED", "BAG_UPDATE"}, OnEvent, nil, OnClick, nil)