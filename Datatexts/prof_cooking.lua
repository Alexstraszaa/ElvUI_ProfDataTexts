...
local profession = "Cooking";
local BonusRace = 'Pandaren';
local SkillCap = 600
local Racial = 15
...
DT:RegisterDatatext('Prof Cooking', {"PLAYER_ENTERING_WORLD", "SKILL_LINES_CHANGED", "BAG_UPDATE"}, OnEvent, nil, OnClick, nil)