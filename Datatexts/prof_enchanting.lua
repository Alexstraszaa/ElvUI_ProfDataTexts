...
local profession = "Enchanting";
local BonusRace = 'Blood Elf';
local SkillCap = 600
local Racial = 10
...
DT:RegisterDatatext('Prof Enchanting', {"PLAYER_ENTERING_WORLD", "SKILL_LINES_CHANGED", "BAG_UPDATE"}, OnEvent, nil, OnClick, nil)