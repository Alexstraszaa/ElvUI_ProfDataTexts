...
local function OnClick(self, btn)
	...
	elseif SkillName == "Fishing" then
		ClickActionLeft = SkillName
--		ClickActionRight = "Find Fish" (tracking)
	elseif SkillName == "First Aid" then
		ClickActionLeft = "First Aid"
--		ClickActionRight = ""
	elseif SkillName == "Herbalism" then
--		ClickActionLeft = "Find Herbs" (tracking)
--		ClickActionRight = "Herb Gathering" or "Lifeblood"
...
--		ClickActionRight = "Find Minirals" (tracking)
	elseif SkillName == "Skinning" then
		ClickActionLeft = SkillName
--		ClickActionRight = "Master of Anatomy"
	...
	if ClickActionRight and ClickActionRight ~= "" or ClickActionRight ~= nil then
...
DT:RegisterDatatext('Prof First Aid', {"PLAYER_ENTERING_WORLD", "SKILL_LINES_CHANGED", "BAG_UPDATE"}, OnEvent, nil, OnClick, nil)